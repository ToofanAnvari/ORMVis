	...
	static
	{
		try
		{
			...
			mxSwingConstants.DEFAULT_VALID_COLOR = Color.GREEN;
                       // mxSwingConstants.DEFAULT_VALID_COLOR = Color.ORANGE;
			...
			mxSwingConstants.EDGE_SELECTION_COLOR = Color.ORANGE;
//                        mxSwingConstants.EDGE_SELECTION_COLOR = Color.green;
			mxSwingConstants.VERTEX_SELECTION_COLOR = Color.ORANGE;
...
//					3, 3 }, 0.0f);
        	...
        	public static Stroke EDGE_SELECTION_STROKE = new BasicStroke(2,
			BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, new float[] {
					3, 3 }, 0.0f);
	/**
...
//					3, 3 }, 0.0f);
        	...
        	public static Stroke VERTEX_SELECTION_STROKE = new BasicStroke(2,
			BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, new float[] {
					3, 3 }, 0.0f);
	/**
